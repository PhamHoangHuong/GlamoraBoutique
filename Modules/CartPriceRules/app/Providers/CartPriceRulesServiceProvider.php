...
namespace Modules\CartPriceRules\Providers;
...
class CartPriceRulesServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CartPriceRules';

    protected string $nameLower = 'cartpricerules';
