...
namespace Modules\Sources\Providers;
...
class SourcesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Sources';

    protected string $nameLower = 'sources';
    ...
    public function register(): void
    {
        ...
        $this->app->bind(SourceProductsRepositoryInterface::class, SourceProductsRepository::class);
    }
